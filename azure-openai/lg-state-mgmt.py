...
class Evaluation(BaseModel):
    result: bool = Field(description="True or False")
...
#result = category_generator.invoke({"research_question": "What is the weather in woodbury in MN?", "tool_response":"This is a joke"})
#print(result)
#input("...")
...
def should_continue(state: AgentState):
    ...
    if isinstance(result, Evaluation):
        ...
        print(colored("Is tool response good and should the flow go to END node? ", "cyan"),
              colored(result.result, "yellow"))
